...
__global__ void d_prepareForceKSpace3D(cufftComplex*, cufftComplex*,
...
void Potential::CalcForces() {
    ...
    // d_cpx1 = d_cpx2 * d_f_k
    d_prepareForceKSpace3D<<<M_Grid, M_Block>>>(this->d_f_k, d_cpx2, d_cpxx, d_cpxy, d_cpxz, Dim, M);
